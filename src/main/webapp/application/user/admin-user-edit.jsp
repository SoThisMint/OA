...
<div class="pd-20">
    <form action="" method="post" class="form form-horizontal" id="form-user-edit">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" class="input-text" value="${sysUser.userPassword}" placeholder="" id="userPassword" name="userPassword"
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" placeholder="组织Id" name="orgId" id="orgId" autocomplete="off"
                       value="${sysUser.orgId}" class="input-text" datatype="*1-20" nullmsg="组织Id不能为空">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input id="d11" value="<fmt:formatDate value="${sysUser.birthday}" pattern="yyyy-MM-dd" />" class="input-text Wdate" readonly="readonly" name="birthday" type="text" onClick="WdatePicker({maxDate:'%y-%M-%d'})"/>
            </div>
            <div class="col-4"></div>
        </div>
        <div>
            ...
            <div class="formControls col-5"> <span class="select-box" style="width:150px;">
				<select class="select" name="flag" id="flag" size="1" value="${sysUser.flag==true?"1":"0"}">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <textarea name="introduce" id="introduce" cols="" rows="" class="textarea" placeholder="说点什么...100个字符以内"
                          dragonfly="true"
                          onKeyUp="textarealength(this,100)">${sysUser.introduce}</textarea>
