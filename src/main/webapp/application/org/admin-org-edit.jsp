...
<body>
<div class="pd-20">
    <form action="" method="post" class="form form-horizontal" id="form-org-edit">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" placeholder="父组织名称" name="orgParentName" id="orgParentName" autocomplete="off"
                       value="${sysOrg.orgParentName}" readonly="readonly" class="input-text" datatype="*2-20"
                       nullmsg="父组织不能为空">
        ...
        <div>
            ...
            <div class="formControls col-5"> <span class="select-box" style="width:150px;">
				<select class="select" name="flag" id="flag" size="1" value="${sysOrg.flag==true?"1":"0"}">
